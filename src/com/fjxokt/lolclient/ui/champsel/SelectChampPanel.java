...
public class SelectChampPanel extends JPanel {
	...
	private class ChampionIconListRenderer extends DefaultListCellRenderer {
		...
		public Component getListCellRendererComponent(JList list, Object value, int index,
			...
			String filePath = Constants.champIconPath + champion.getIconPath();
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (client.isPlayer()) {
					...
					if (champ != null) {
						...
						AudioManager.getInst().playSound(Constants.soundsChampsPath + c.getSelectSoundPath().replaceAll(Constants.language, ""));
					}
				}
			}
		});
